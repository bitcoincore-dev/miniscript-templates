-:
	@type -P pandoc >/tmp/miniscript-template.log && pandoc --preserve-tabs --ascii --from=mediawiki --to=html README.mediawiki | sed 's/__NOTOC__//' > readme.html
	...
	@type -P pandoc && pandoc -s README.mediawiki -o index.html 2>/dev/null || \
